...
![CDSAnalyticsEventHubClusters](Analytics/CDSAnalyticsEventHubClusters_tbg.png) | `CDSAnalyticsEventHubClusters`<br>`CDSAnalyticsEventHubClusters_m` |
...
![CDSAzurestackMarketplaceManagement](Azurestack/CDSAzurestackMarketplaceManagement_tbg.png) | `CDSAzurestackMarketplaceManagement`<br>`CDSAzurestackMarketplaceManagement_m` |
...
![CDSBlockchainBCDevKit](Blockchain/CDSBlockchainBCDevKit_tbg.png) | `CDSBlockchainBCDevKit`<br>`CDSBlockchainBCDevKit_m` |
...
![CDSCommandArrowLeft](Command/CDSCommandArrowLeft_tbg.png) | `CDSCommandArrowLeft`<br>`CDSCommandArrowLeft_m` |
...
![CDSCommandCancelled](Command/CDSCommandCancelled_tbg.png) | `CDSCommandCancelled`<br>`CDSCommandCancelled_m` |
...
![CDSCommandDetails](Command/CDSCommandDetails_tbg.png) | `CDSCommandDetails`<br>`CDSCommandDetails_m` |
...
![CDSCommandFeedback](Command/CDSCommandFeedback_tbg.png) | `CDSCommandFeedback`<br>`CDSCommandFeedback_m` |
...
![CDSCommandHappy](Command/CDSCommandHappy_tbg.png) | `CDSCommandHappy`<br>`CDSCommandHappy_m` |
...
![CDSCommandLine](Command/CDSCommandLine_tbg.png) | `CDSCommandLine`<br>`CDSCommandLine_m` |
...
![CDSCommandPerson](Command/CDSCommandPerson_tbg.png) | `CDSCommandPerson`<br>`CDSCommandPerson_m` |
...
![CDSCommandReimage](Command/CDSCommandReimage_tbg.png) | `CDSCommandReimage`<br>`CDSCommandReimage_m` |
...
![CDSCommandSmileyNeutral](Command/CDSCommandSmileyNeutral_tbg.png) | `CDSCommandSmileyNeutral`<br>`CDSCommandSmileyNeutral_m` |
...
![CDSCommandTools](Command/CDSCommandTools_tbg.png) | `CDSCommandTools`<br>`CDSCommandTools_m` |
...
![CDSCommandWarning](Command/CDSCommandWarning_tbg.png) | `CDSCommandWarning`<br>`CDSCommandWarning_m` |
...
![CDSComputeDisks](Compute/CDSComputeDisks_tbg.png) | `CDSComputeDisks`<br>`CDSComputeDisks_m` |
...
![CDSComputeVirtualMachine](Compute/CDSComputeVirtualMachine_tbg.png) | `CDSComputeVirtualMachine`<br>`CDSComputeVirtualMachine_m` |
...
![CDSContainersServiceFabricClusters](Containers/CDSContainersServiceFabricClusters_tbg.png) | `CDSContainersServiceFabricClusters`<br>`CDSContainersServiceFabricClusters_m` |
...
![CDSDatabasesCacheRedis](Databases/CDSDatabasesCacheRedis_tbg.png) | `CDSDatabasesCacheRedis`<br>`CDSDatabasesCacheRedis_m` |
...
![CDSGeneralCostManagement](General/CDSGeneralCostManagement_tbg.png) | `CDSGeneralCostManagement`<br>`CDSGeneralCostManagement_m` |
...
![CDSGeneralServiceHealth](General/CDSGeneralServiceHealth_tbg.png) | `CDSGeneralServiceHealth`<br>`CDSGeneralServiceHealth_m` |
...
![CDSIdentityAzureADB2C](Identity/CDSIdentityAzureADB2C_tbg.png) | `CDSIdentityAzureADB2C`<br>`CDSIdentityAzureADB2C_m` |
...
![CDSIntegrationEventGridSubscriptions](Integration/CDSIntegrationEventGridSubscriptions_tbg.png) | `CDSIntegrationEventGridSubscriptions`<br>`CDSIntegrationEventGridSubscriptions_m` |
...
!define AzurePuml https://raw.githubusercontent.com/czmirek/PlantUML-AzureIcons/main/dist
!include AzurePuml/AzureCommon.puml
!include AzurePuml/azure-cds/Machinelearning/all.puml
```
Image | Macro
| --- | ---
![CDSMachinelearningBatchAI](Machinelearning/CDSMachinelearningBatchAI_tbg.png) | `CDSMachinelearningBatchAI`<br>`CDSMachinelearningBatchAI_m` |
![CDSMachinelearningBotServices](Machinelearning/CDSMachinelearningBotServices_tbg.png) | `CDSMachinelearningBotServices`<br>`CDSMachinelearningBotServices_m` |
![CDSMachinelearningCognitiveServices](Machinelearning/CDSMachinelearningCognitiveServices_tbg.png) | `CDSMachinelearningCognitiveServices`<br>`CDSMachinelearningCognitiveServices_m` |
![CDSMachinelearningGenomics](Machinelearning/CDSMachinelearningGenomics_tbg.png) | `CDSMachinelearningGenomics`<br>`CDSMachinelearningGenomics_m` |
![CDSMachinelearningMachineLearningServiceWorkspaces](Machinelearning/CDSMachinelearningMachineLearningServiceWorkspaces_tbg.png) | `CDSMachinelearningMachineLearningServiceWorkspaces`<br>`CDSMachinelearningMachineLearningServiceWorkspaces_m` |
![CDSMachinelearningMachineLearningStudioWebServicePlans](Machinelearning/CDSMachinelearningMachineLearningStudioWebServicePlans_tbg.png) | `CDSMachinelearningMachineLearningStudioWebServicePlans`<br>`CDSMachinelearningMachineLearningStudioWebServicePlans_m` |
![CDSMachinelearningMachineLearningStudioWebServices](Machinelearning/CDSMachinelearningMachineLearningStudioWebServices_tbg.png) | `CDSMachinelearningMachineLearningStudioWebServices`<br>`CDSMachinelearningMachineLearningStudioWebServices_m` |
![CDSMachinelearningMachineLearningStudioWorkspaces](Machinelearning/CDSMachinelearningMachineLearningStudioWorkspaces_tbg.png) | `CDSMachinelearningMachineLearningStudioWorkspaces`<br>`CDSMachinelearningMachineLearningStudioWorkspaces_m` |
![CDSMachinelearningremoterendering](Machinelearning/CDSMachinelearningremoterendering_tbg.png) | `CDSMachinelearningremoterendering`<br>`CDSMachinelearningremoterendering_m` |
...
!define AzurePuml https://raw.githubusercontent.com/czmirek/PlantUML-AzureIcons/main/dist
!include AzurePuml/AzureCommon.puml
!include AzurePuml/azure-cds/Manage/all.puml
```
Image | Macro
| --- | ---
![CDSManageActivityLog](Manage/CDSManageActivityLog_tbg.png) | `CDSManageActivityLog`<br>`CDSManageActivityLog_m` |
![CDSManageAdvisor](Manage/CDSManageAdvisor_tbg.png) | `CDSManageAdvisor`<br>`CDSManageAdvisor_m` |
![CDSManageAlerts](Manage/CDSManageAlerts_tbg.png) | `CDSManageAlerts`<br>`CDSManageAlerts_m` |
![CDSManageApplicationInsights](Manage/CDSManageApplicationInsights_tbg.png) | `CDSManageApplicationInsights`<br>`CDSManageApplicationInsights_m` |
![CDSManageAutomationAccounts](Manage/CDSManageAutomationAccounts_tbg.png) | `CDSManageAutomationAccounts`<br>`CDSManageAutomationAccounts_m` |
![CDSManageAzureArc](Manage/CDSManageAzureArc_tbg.png) | `CDSManageAzureArc`<br>`CDSManageAzureArc_m` |
![CDSManageBlueprints](Manage/CDSManageBlueprints_tbg.png) | `CDSManageBlueprints`<br>`CDSManageBlueprints_m` |
![CDSManageCompliance](Manage/CDSManageCompliance_tbg.png) | `CDSManageCompliance`<br>`CDSManageCompliance_m` |
![CDSManageCostManagementandBilling](Manage/CDSManageCostManagementandBilling_tbg.png) | `CDSManageCostManagementandBilling`<br>`CDSManageCostManagementandBilling_m` |
![CDSManageCustomerLockboxforMicrosoftAzure](Manage/CDSManageCustomerLockboxforMicrosoftAzure_tbg.png) | `CDSManageCustomerLockboxforMicrosoftAzure`<br>`CDSManageCustomerLockboxforMicrosoftAzure_m` |
![CDSManageDiagnosticsSettings](Manage/CDSManageDiagnosticsSettings_tbg.png) | `CDSManageDiagnosticsSettings`<br>`CDSManageDiagnosticsSettings_m` |
![CDSManageEducation](Manage/CDSManageEducation_tbg.png) | `CDSManageEducation`<br>`CDSManageEducation_m` |
![CDSManageLogAnalyticsWorkspaces](Manage/CDSManageLogAnalyticsWorkspaces_tbg.png) | `CDSManageLogAnalyticsWorkspaces`<br>`CDSManageLogAnalyticsWorkspaces_m` |
![CDSManageMachinesAzureArc](Manage/CDSManageMachinesAzureArc_tbg.png) | `CDSManageMachinesAzureArc`<br>`CDSManageMachinesAzureArc_m` |
![CDSManageManagedApplicationsCenter](Manage/CDSManageManagedApplicationsCenter_tbg.png) | `CDSManageManagedApplicationsCenter`<br>`CDSManageManagedApplicationsCenter_m` |
![CDSManageManagedDesktop](Manage/CDSManageManagedDesktop_tbg.png) | `CDSManageManagedDesktop`<br>`CDSManageManagedDesktop_m` |
![CDSManageMetrics](Manage/CDSManageMetrics_tbg.png) | `CDSManageMetrics`<br>`CDSManageMetrics_m` |
![CDSManageMonitor](Manage/CDSManageMonitor_tbg.png) | `CDSManageMonitor`<br>`CDSManageMonitor_m` |
![CDSManageMyCustomers](Manage/CDSManageMyCustomers_tbg.png) | `CDSManageMyCustomers`<br>`CDSManageMyCustomers_m` |
...
![CDSNetworkingFrontDoors](Networking/CDSNetworkingFrontDoors_tbg.png) | `CDSNetworkingFrontDoors`<br>`CDSNetworkingFrontDoors_m` |
...
![CDSOtherSQLServerRegistries](Other/CDSOtherSQLServerRegistries_tbg.png) | `CDSOtherSQLServerRegistries`<br>`CDSOtherSQLServerRegistries_m` |
![CDSOtherUniversalPrintService](Other/CDSOtherUniversalPrintService_tbg.png) | `CDSOtherUniversalPrintService`<br>`CDSOtherUniversalPrintService_m` |
![CDSOtherVirtualWANs](Other/CDSOtherVirtualWANs_tbg.png) | `CDSOtherVirtualWANs`<br>`CDSOtherVirtualWANs_m` |
![CDSOtherWAC](Other/CDSOtherWAC_tbg.png) | `CDSOtherWAC`<br>`CDSOtherWAC_m` |
...
!define AzurePuml https://raw.githubusercontent.com/czmirek/PlantUML-AzureIcons/main/dist
!include AzurePuml/AzureCommon.puml
!include AzurePuml/azure-cds/Security/all.puml
```
Image | Macro
| --- | ---
![CDSSecurityApplicationGateway](Security/CDSSecurityApplicationGateway_tbg.png) | `CDSSecurityApplicationGateway`<br>`CDSSecurityApplicationGateway_m` |
![CDSSecurityApplicationSecurityGroups](Security/CDSSecurityApplicationSecurityGroups_tbg.png) | `CDSSecurityApplicationSecurityGroups`<br>`CDSSecurityApplicationSecurityGroups_m` |
![CDSSecurityAzureActiveDirectory](Security/CDSSecurityAzureActiveDirectory_tbg.png) | `CDSSecurityAzureActiveDirectory`<br>`CDSSecurityAzureActiveDirectory_m` |
![CDSSecurityAzureAttestation](Security/CDSSecurityAzureAttestation_tbg.png) | `CDSSecurityAzureAttestation`<br>`CDSSecurityAzureAttestation_m` |
![CDSSecurityAzureInformationProtection](Security/CDSSecurityAzureInformationProtection_tbg.png) | `CDSSecurityAzureInformationProtection`<br>`CDSSecurityAzureInformationProtection_m` |
![CDSSecurityAzureSentinel](Security/CDSSecurityAzureSentinel_tbg.png) | `CDSSecurityAzureSentinel`<br>`CDSSecurityAzureSentinel_m` |
![CDSSecurityExtendedSecurityUpdates](Security/CDSSecurityExtendedSecurityUpdates_tbg.png) | `CDSSecurityExtendedSecurityUpdates`<br>`CDSSecurityExtendedSecurityUpdates_m` |
![CDSSecurityKeyVaults](Security/CDSSecurityKeyVaults_tbg.png) | `CDSSecurityKeyVaults`<br>`CDSSecurityKeyVaults_m` |
![CDSSecuritySecurityCenter](Security/CDSSecuritySecurityCenter_tbg.png) | `CDSSecuritySecurityCenter`<br>`CDSSecuritySecurityCenter_m` |
![CDSSecurityVirtualNetworkGateways](Security/CDSSecurityVirtualNetworkGateways_tbg.png) | `CDSSecurityVirtualNetworkGateways`<br>`CDSSecurityVirtualNetworkGateways_m` |
...
!define AzurePuml https://raw.githubusercontent.com/czmirek/PlantUML-AzureIcons/main/dist
!include AzurePuml/AzureCommon.puml
!include AzurePuml/azure-cds/Status/all.puml
```
Image | Macro
| --- | ---
![CDSStatusCancelled](Status/CDSStatusCancelled_tbg.png) | `CDSStatusCancelled`<br>`CDSStatusCancelled_m` |
![CDSStatusCancelledOutline](Status/CDSStatusCancelledOutline_tbg.png) | `CDSStatusCancelledOutline`<br>`CDSStatusCancelledOutline_m` |
![CDSStatusDisabled](Status/CDSStatusDisabled_tbg.png) | `CDSStatusDisabled`<br>`CDSStatusDisabled_m` |
![CDSStatusDisabledOutline](Status/CDSStatusDisabledOutline_tbg.png) | `CDSStatusDisabledOutline`<br>`CDSStatusDisabledOutline_m` |
![CDSStatusFailed](Status/CDSStatusFailed_tbg.png) | `CDSStatusFailed`<br>`CDSStatusFailed_m` |
![CDSStatusFailedOutline](Status/CDSStatusFailedOutline_tbg.png) | `CDSStatusFailedOutline`<br>`CDSStatusFailedOutline_m` |
![CDSStatusInfo](Status/CDSStatusInfo_tbg.png) | `CDSStatusInfo`<br>`CDSStatusInfo_m` |
![CDSStatusInfoOutline](Status/CDSStatusInfoOutline_tbg.png) | `CDSStatusInfoOutline`<br>`CDSStatusInfoOutline_m` |
![CDSStatusNone](Status/CDSStatusNone_tbg.png) | `CDSStatusNone`<br>`CDSStatusNone_m` |
![CDSStatusNoneOutline](Status/CDSStatusNoneOutline_tbg.png) | `CDSStatusNoneOutline`<br>`CDSStatusNoneOutline_m` |
![CDSStatusPending](Status/CDSStatusPending_tbg.png) | `CDSStatusPending`<br>`CDSStatusPending_m` |
![CDSStatusPendingOutline](Status/CDSStatusPendingOutline_tbg.png) | `CDSStatusPendingOutline`<br>`CDSStatusPendingOutline_m` |
![CDSStatusStopped](Status/CDSStatusStopped_tbg.png) | `CDSStatusStopped`<br>`CDSStatusStopped_m` |
